...
public class ImparesDTO {
	...
	public ImparesDTO(int maior, String dataMaior, int maiorFrequencia, int menor, String dataMenor,
			int menorFrequencia, List<Frequencia> lista) {
		super();
		this.maior = maior;
